class User < ActiveRecord::Base
	...
	attr_accessible :name, :email, :password, :password_confirmation, :deal_duration, :private, :accept_terms, :photo, :time_zone, :active, :image_remote_url, :image_url, :subscribe, :monthly, :partner, :reply_alert, :friend_alert
